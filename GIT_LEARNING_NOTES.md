...
## 📌 Phase 3: Image Alt Text Implementation

### 13.1 Image Alt Text คืออะไร?

**Alt text** = ข้อความอธิบายรูปภาพสำหรับ:
- ✅ SEO (search engines)
- ✅ Accessibility (screen readers)
- ✅ User experience (เมื่อโหลดช้า)

### Step 1: Analyze Images

**ตรวจสอบทั้ง 13 product pages:**
```
Total Images: 119
✅ Already good: 65 (logo, flag, product name)
❌ Need fix: 54 (gallery images)
```

**Products with images needing update:**
```
1. mbb.html — 10 images
2. ssb.html — 3 images
3. ldpe-hdpe.html — 1 image
4. vacuum-nylon.html — 5 images
5. hic.html — 5 images
6. air-bubble.html — 2 images
7. cushion-wrap.html — 8 images
8. sulfur-free-paper.html — 2 images
9. cotton-swabs.html — 4 images
10. foam-swabs.html — 1 image
11. wipers.html — 1 image
12. garments.html — 3 images
13. gloves.html — 7 images
```

### Step 2: Pattern to Update
...
**To:**
```html
<img alt="Moisture Barrier Bags - Product gallery shot 1">
```

### Step 3: Automated Update Script

**ใช้ Python regex เพื่อแก้ไข 52 images:**
```python
pattern: alt="slug-(\d+)\.(png|jpg)"
replacement: alt="Product Name - Product gallery shot N"
```

**Result:**
- ✅ 40 images (11 files) — first batch
- ✅ 12 images (3 files) — remaining batch
- **Total: 52 images updated**

### Step 4: Commit

**Commit:**
```
748aa81 feat: update image alt text for seo (phase 3)
```
...
```
✅ 13 product pages
✅ 52 gallery images updated
✅ Alt text pattern: "Product Name - Product gallery shot N"
```

---

**สร้าง:** 2026-06-13  
**ทำการแก้ไขล่าสุด:** 2026-06-13 (Phase 3 image alt text)
